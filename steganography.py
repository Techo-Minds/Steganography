...
root=tk.Tk()
root.title("Steganography - Hide a Secret Text Mesage in an Image")
...
#icon
image_icon=tk.PhotoImage(file="logo.jpg")
root.iconphoto(False, image_icon)

#logo
logo=PhotoImage(file="logo.png")
Label(root,image=logo,bg="#bf4155").place(x=10,y=0)

Label(root,text="CYBER SCIENCE",bg="#2d4155",fg="white",font="Ariel 25 bold").place(x=100,y=30)
...
Button(frame3,text="Open Image",width=10,height=2,font="Ariel 14 bold",command=showimage).place(x=20,y=30)
Button(frame3,text="Save Image",width=10,height=2,font="Ariel 14 bold",command=save).place(x=180,y=30)
